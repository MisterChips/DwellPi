...
MENU_TREE = {
    ...
    "SETTINGS": [
        ...
        {"label": "Heatup Rate",   "action": "edit_heatup_rate"},
        ...
        {"label": "Warmup Min",    "action": "edit_minimum_heating_startup_time"},
        {"label": "Warmup Max",    "action": "edit_maximum_heating_startup_time"},
        {"label": "Target Offset", "action": "edit_target_setpoint_offset"},
